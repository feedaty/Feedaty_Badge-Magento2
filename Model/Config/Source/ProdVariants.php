...
class ProdVariants implements ArrayInterface
{
    ...
    */
    ...
    public function toOptionArray()
    {
        ...
        $plugin_enabled = $this->scopeConfig->getValue('feedaty_badge_options/widget_products/product_enabled', $store_scope);
        $badge_style = $this->scopeConfig->getValue('feedaty_badge_options/widget_products/product_style', $store_scope);
